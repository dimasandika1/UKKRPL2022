...
<body class="bg-gradient-primary">
    ...
    <div class="row justify-content-center">
		...
		<div class="col-x1-6 col-lg-12 col-md-9">
						...
						<div class="col-lg-12">
							<div class="p-5">
								<div class="text-center">
									<h1 class="h4 text-gray-900 mb-2">Selamat Datang di aplikasi Peduli Dimas </h1>
								...
								<form class="user" method="post" action="proses_login.php">
									...
									<button type="submit" class="btn btn-primary btn-user btn-block">
										<i class="fa fa-spinner"></i>Login</button>
									<hr>
									<a href="register.php" class="btn btn-facebook btn-user btn-block">Belum Punya Akun...?Silahkan ke halaman Register<i class="fa fa-arrow-right fa-fw"></i>
									</a>
								</form>
							</div>
                           </div>
