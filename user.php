...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
					<h3>Peduli Diri - Aplikasi Pencatatan Perjalanan</h3>
				</nav>
                <!-- End of Topbar -->
    ...
    <!-- Page level plugins -->
    <script src="vendor/chart.js/jquery.datatables.min.js"></script>
	<script src="vendor/datables/dataTables.bootstrap4.min.js"></script>
