						...
						<div class="col-lg-12">
							<div class="p-5">
								<div class="text-center">
									<h1 class="h4 text-gray-900 mb-2">Register Akun Aplikasi Peduli Diri</h1>
								...
								<form class="user" method="post" action="proses_register.php">
									...
									<button type="submit" class="btn btn-primary btn-user btn-block">
										<i class="fa fa-spinner"></i>Register</button>
									<hr>
									<a href="index.php" class="btn btn-facebook btn-user btn-block">
									<i class="fa fa-arrow-right fa-fw"></i>Sudah Punya Akun...?Silahkan ke halaman Login
									</a>
								</form>
                             </div>
                           </div>
